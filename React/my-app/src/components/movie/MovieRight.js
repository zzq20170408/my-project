...
export default class MovieRight extends Component{
    state={
        location:'',
        val:'',
    }
        ...
        return(
            <div className="MovieRight">
                ...
                >
                    ...
                    />
                    <a href={`https://movie.douban.com/cinema/search/108288/?q=${this.state.val}`}>
                        <img alt=""
                ...
                <ul className="follow_us clearfix">
                    ...
                    <li className="fl">
                        <a href="http://weibo.com/login.php">
                            <img 
                            alt=""
                            src={require('../../images/follow_us1.png')}
                            />
                        </a>
                        <a href="http://weibo.com/login.php">
                            微博
                    ...
                    <li className="fl">
                        <a href="####">
                            <img 
                            alt=""
                            src={require('../../images/follow_us2.png')}
                            />
                        </a>
                        <a href="####">
                            微信
                    ...
                    <li className="fl">
                        <a href="https://site.douban.com/doubanfilmawards/">
                            <img 
                            alt=""
                            src={require('../../images/follow_us3.png')}
                            />
                        </a>
                        <a href="https://site.douban.com/doubanfilmawards/">
                            鑫像奖小站
                    ...
                    <li className="fl">
                        <a href="https://site.douban.com/movieclub/">
                            <img 
                            alt=""
                            src={require('../../images/follow_us4.png')}
                            />
                        </a>
                        <a href="https://site.douban.com/movieclub/">
                            观影club
